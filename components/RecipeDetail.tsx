  ...
  return (
    <div className="animate-fade-in">
      <div className="p-4 sticky top-[81px] bg-gray-900 z-10 border-b border-gray-800">
        <button
          onClick={onBack}
          className="flex items-center px-4 py-2 bg-gray-800 border border-gray-700 rounded-full font-semibold text-base text-gray-300 hover:bg-gray-700 transition-colors"
        >
          <BackArrowIcon />
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="flex flex-wrap gap-4 items-center mb-8">
            ...
            >
              ...
              <span className={`text-base ${language === 'bn' ? 'font-bengali' : ''}`}>
                {isFavorite ? favoriteButtonText[language].favorited : favoriteButtonText[language].favorite}
              </span>
            </button>
        </div>
