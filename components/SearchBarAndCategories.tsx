...
const BANNER_IMAGE_URL =
 "https://images.pexels.com/photos/6593580/pexels-photo-6593580.jpeg";

const SearchBarAndCategories: React.FC<SearchBarAndCategoriesProps> = ({
 onSearch,
 isLoading,
 language,
}) => {
 ...
 return (
  <div className="p-4 md:p-6 text-center">
   ...
   >
    {language === "en"
     ? "Find delicious recipes tailored for you."
     : "আপনার জন্য তৈরি সুস্বাদু রেসিপি খুঁজুন।"}
   </p>
   ...
   <form onSubmit={handleSearch} className="max-w-2xl mx-auto mb-8">
    <div className="relative">
     <input
      ...
      disabled={isLoading}
      className={`w-full pl-12 pr-32 md:pr-40 py-4 bg-gray-800 border-2 border-gray-700 text-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-shadow duration-300 text-lg ${
       language === "bn" ? "font-bengali" : ""
      }`}
     />
   ...
   <div className="max-w-4xl mx-auto">
    <h3
     className={`text-[20.5px] font-semibold text-gray-300 mb-4 ${
      language === "bn" ? "font-bengali" : ""
     }`}
    >
     {language === "en"
      ? "Or browse by category"
      : "অথবা বিভাগ থেকে ব্রাউজ করুন"}
    </h3>
     ...
     {CATEGORIES.map((category) => (
      ...
      >
       ...
       <div className="absolute inset-0 bg-black/50 group-hover:bg-black/60 transition-colors flex items-center justify-center p-2">
        <h4
         className={`text-white font-bold text-[18.25px] text-center ${
          language === "bn" ? "font-bengali" : ""
         }`}
        >
         {category.name}
