...
const RecipeCard: React.FC<RecipeCardProps> = ({
 ...
 return (
  <div className="bg-gray-800 rounded-lg shadow-md overflow-hidden group transform hover:-translate-y-1 transition-all duration-300 relative">
   <div onClick={() => onSelect(recipe)} className="cursor-pointer">
    ...
    <div className="p-4">
     ...
     <h3
      className={`text-[20.5px] font-bold text-gray-100 mt-1 truncate ${
       language === "bn" ? "font-bengali" : ""
      }`}
      title={recipeName}
     >
